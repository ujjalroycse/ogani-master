    ...
    <!-- <div class="splash-container">
        <div class="card ">
            <div class="card-header text-center">
                <a href="verification.php"><img style="width: 100px;" src="img/logo.png" alt=""></a>
                <?php if(!isset($_POST['verification'])) : ?>
                <span class="splash-description">Please chak your email <b class="text-primary"><?php echo $_SESSION['user_email'] ?></b>.Then submit the code.</span>
            </div>
                <?php endif; ?>
            <div class="card-body">
                <?php if(isset($error)) : ?>
                ...
                <form action="" method="POST">
                    <div class="form-group">
                        <input class="form-control form-control-lg" id="email" name="email_code" type="text" placeholder="Email Code">
                    </div>
                    <button type="submit" name="verification" class="btn btn-primary btn-lg btn-block">Verification</button>
                </form>
                <?php else: ?>
                    <p>Your email verification Successfully. Click On Home Page <a class="btn btn-success" href="index.php">Home</a></p> 
                <?php endif; ?>
            </div>
        </div>
    </div> -->
...
<body class="animsition">
                ...
                <div class="login-wrap">
                    <div class="login-content">
                        <div class="login-logo">
                            <a href="verification.php"><img src="img/logo.png" alt="CoolAdmin"></a>
                            <br>
                            <?php if(!isset($_POST['verification'])) : ?>
                            <span class="splash-description">Please chak your email <b class="text-primary"><?php echo $_SESSION['user_email'] ?></b>.Then submit the code.</span>
                            <?php endif; ?>
    ...
    <!-- Main JS-->
    <script src="admin/js/main.js"></script>admin/
