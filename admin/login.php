...
if(isset($_POST['admin_login'])){
    ...
    elseif(empty($password)){
        ...
        $login = $connection->prepare("SELECT * FROM admins WHERE username=? AND password=?");
                    ...
                    <div class="login-content">
                        ...
                        <div class="login-form">
                            <form action="" method="POST">
                                ...
                                <button class="au-btn au-btn--block au-btn--green m-b-20" name="admin_login" type="submit">Login</button>
                            </form>
